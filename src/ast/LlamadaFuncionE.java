...
public class LlamadaFuncionE extends AbstractExpresion {
	...
	public LlamadaFuncionE(String nombre, List<Expresion> parametros) {
		this.nombre = nombre;
	...
	public LlamadaFuncionE(Object nombre, Object parametros) {
